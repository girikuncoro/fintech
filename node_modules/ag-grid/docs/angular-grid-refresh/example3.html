...
<body ng-app="example" ng-controller="exampleCtrl">
    <div style="height: 6%;">
        <button ng-click="onRefreshAll()">Refresh All</button>
        <button ng-click="onDoubleJillian()">Double Jillian</button>
        <button ng-click="onDoubleNiall()">Double Niall</button>
    </div>
    <div style="height: 94%;" ag-grid="gridOptions" class="ag-fresh"></div>
</body>
</html>
